...
public class ValidAndInvalidData extends ExtentReports {
	WebDriver driver;
	  @Test
	  public void Testcase2() throws InterruptedException {
		  ...
		  driver.findElement(By.xpath("//input[@name='userMobile']")).sendKeys("98765abcde");
		  driver.findElement(By.xpath("//input[@name='userEmail']")).sendKeys("abc@bca.com");
